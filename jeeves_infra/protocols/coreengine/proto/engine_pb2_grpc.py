...
class CommBusServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Publish = channel.unary_unary(
                ...
                request_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusPublishRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusPublishResponse.FromString,
                _registered_method=True)
        self.Send = channel.unary_unary(
                '/jeeves.engine.v1.CommBusService/Send',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusSendRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusSendResponse.FromString,
                _registered_method=True)
        self.Query = channel.unary_unary(
                '/jeeves.engine.v1.CommBusService/Query',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusQueryRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusQueryResponse.FromString,
                _registered_method=True)
        self.Subscribe = channel.unary_stream(
                '/jeeves.engine.v1.CommBusService/Subscribe',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusSubscribeRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusEvent.FromString,
                _registered_method=True)
...
def add_CommBusServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Publish': grpc.unary_unary_rpc_method_handler(
                    servicer.Publish,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusPublishRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusPublishResponse.SerializeToString,
            ),
            'Send': grpc.unary_unary_rpc_method_handler(
                    servicer.Send,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusSendRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusSendResponse.SerializeToString,
            ),
            'Query': grpc.unary_unary_rpc_method_handler(
                    servicer.Query,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusQueryRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusQueryResponse.SerializeToString,
            ),
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.CommBusSubscribeRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.CommBusEvent.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class CommBusService(object):
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.CommBusService/Publish',
            coreengine_dot_proto_dot_engine__pb2.CommBusPublishRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.CommBusPublishResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Send(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.CommBusService/Send',
            coreengine_dot_proto_dot_engine__pb2.CommBusSendRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.CommBusSendResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Query(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.CommBusService/Query',
            coreengine_dot_proto_dot_engine__pb2.CommBusQueryRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.CommBusQueryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/jeeves.engine.v1.CommBusService/Subscribe',
            coreengine_dot_proto_dot_engine__pb2.CommBusSubscribeRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.CommBusEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class OrchestrationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitializeSession = channel.unary_unary(
                ...
                request_serializer=coreengine_dot_proto_dot_engine__pb2.InitializeSessionRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.SessionState.FromString,
                _registered_method=True)
        self.GetNextInstruction = channel.unary_unary(
                '/jeeves.engine.v1.OrchestrationService/GetNextInstruction',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.GetNextInstructionRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.Instruction.FromString,
                _registered_method=True)
        self.ReportAgentResult = channel.unary_unary(
                '/jeeves.engine.v1.OrchestrationService/ReportAgentResult',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.ReportAgentResultRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.Instruction.FromString,
                _registered_method=True)
        self.GetSessionState = channel.unary_unary(
                '/jeeves.engine.v1.OrchestrationService/GetSessionState',
                request_serializer=coreengine_dot_proto_dot_engine__pb2.GetSessionStateRequest.SerializeToString,
                response_deserializer=coreengine_dot_proto_dot_engine__pb2.SessionState.FromString,
                _registered_method=True)
...
def add_OrchestrationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InitializeSession': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.InitializeSessionRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.SessionState.SerializeToString,
            ),
            'GetNextInstruction': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNextInstruction,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.GetNextInstructionRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.Instruction.SerializeToString,
            ),
            'ReportAgentResult': grpc.unary_unary_rpc_method_handler(
                    servicer.ReportAgentResult,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.ReportAgentResultRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.Instruction.SerializeToString,
            ),
            'GetSessionState': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSessionState,
                    request_deserializer=coreengine_dot_proto_dot_engine__pb2.GetSessionStateRequest.FromString,
                    response_serializer=coreengine_dot_proto_dot_engine__pb2.SessionState.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class OrchestrationService(object):
    ...
    def InitializeSession(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.OrchestrationService/InitializeSession',
            coreengine_dot_proto_dot_engine__pb2.InitializeSessionRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.SessionState.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetNextInstruction(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.OrchestrationService/GetNextInstruction',
            coreengine_dot_proto_dot_engine__pb2.GetNextInstructionRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.Instruction.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ReportAgentResult(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.OrchestrationService/ReportAgentResult',
            coreengine_dot_proto_dot_engine__pb2.ReportAgentResultRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.Instruction.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetSessionState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jeeves.engine.v1.OrchestrationService/GetSessionState',
            coreengine_dot_proto_dot_engine__pb2.GetSessionStateRequest.SerializeToString,
            coreengine_dot_proto_dot_engine__pb2.SessionState.FromString,
            options,
            channel_credentials,
            insecure,
